...
import { bulkDeleteVideos, deleteVideo } from "./actions";

const FORM_ID = "admin-videos-bulk";

export function VideosTable({ data }: { data: Video[] }) {
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="px-4">제목 / 출연</TableHead>
                <TableHead className="w-32 px-4">게시일</TableHead>
              ...
              {data.map((v) => (
                <TableRow key={v.id}>
                  ...
                  <TableCell className="px-4 py-3">
                    ...
                    <img
                      src={youtubeThumb(v.youtube_id, "hq")}
                      alt=""
                  ...
                  <TableCell className="max-w-[420px] px-4 align-top">
                    ...
                    {v.performer ? (
                      <p className="mt-1 text-xs text-warm-gray">{v.performer}</p>
                    ) : null}
                  </TableCell>
                  <TableCell className="px-4 text-warm-gray">
                    {format(parseISO(v.video_date), "yyyy.MM.dd")}
                  </TableCell>
